...
--
-- Host: localhost
-- Generation Time: Oct 14, 2018 at 11:04 AM
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `salary` varchar(30),
  `spouse` varchar(30),
  `spouse_no` varchar(30),
  `spouse_emp` varchar(50),
  `spouse_details` varchar(100),
  `spouse_income` decimal(10,2),
  `comaker` varchar(30),
  `comaker_details` varchar(100),
  `branch_id` int(11) NOT NULL,
  `credit_status` varchar(10),
  `ci_remarks` varchar(1000),
  `ci_name` varchar(50),
  `ci_date` date,
  `payslip` varchar(30),
  `valid_id` varchar(30),
...
(6, 'RMMC', 'Ruel', 'L', 'Cadiz', 'GENERAL SANTOS CITY', '554678', '', 0, '0.00', 'default.gif', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0.00', '', '', 1, '', 'Approved', '', '0000-00-00', '2', '2', '2', '', '2'),
(7, 'RMMC', 'Jim', 'D', 'Jamero', 'GENERAL SANTOS CITY', '6678956', '', 0, '2000.00', 'default.gif', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0.00', '', '', 1, '', 'Approved', '', '0000-00-00', '2', '2', '2', '', '2'),
(8, 'JKHJBHJB', 'Nicole', 'A', 'Cabrezos', 'hjhbhjbhj', '7867675', '', 0, '15900.00', 'default.gif', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0.00', '', '', 1, '', 'Approved', '', '0000-00-00', '2', '2', '2', '', '2');
...
(245, 1, 'has logged in the system at ', '2018-07-07 15:02:24'),
(246, 1, 'has logged in the system at ', '2018-07-07 15:24:46'),
(247, 1, 'added 100 of ', '2018-07-07 15:33:18'),
(248, 1, 'has logged in the system at ', '2018-07-07 16:11:34'),
(249, 1, 'has logged in the system at ', '2018-07-08 14:02:09'),
(250, 1, 'has logged out the system at ', '2018-07-08 14:20:06'),
(251, 1, 'has logged in the system at ', '2018-09-05 19:37:53'),
(252, 1, 'has logged in the system at ', '2018-09-13 16:16:39'),
(253, 1, 'has logged out the system at ', '2018-09-13 16:37:53'),
(254, 1, 'has logged in the system at ', '2018-09-13 16:38:21'),
(255, 1, 'has logged out the system at ', '2018-09-13 16:38:31'),
(256, 1, 'has logged in the system at ', '2018-09-13 16:39:22'),
(257, 1, 'has logged in the system at ', '2018-09-13 17:04:33'),
(258, 1, 'has logged out the system at ', '2018-09-13 17:04:47'),
(259, 1, 'has logged in the system at ', '2018-09-13 17:05:39'),
(260, 1, 'added a payment of -7170 for , ', '2018-09-13 00:00:00'),
(261, 1, 'has logged in the system at ', '2018-09-14 09:48:35'),
(262, 1, 'has logged in the system at ', '2018-10-14 18:32:28'),
(263, 1, 'has logged out the system at ', '2018-10-14 18:32:36'),
(264, 1, 'has logged in the system at ', '2018-10-14 18:33:36');
...
(46, 6, 10, '9000.00', '2018-09-13 17:10:15', 1, 1, '2018-04-25', '15900.00', '0.00', '3240.00', 'partially paid', '0.00', 0),
...
(52, 7, 11, '211.00', '2018-03-25 22:22:17', 1, 1, '2018-08-25', '2650.00', '60.00', '370.00', 'partially paid', '0.00', 0),
...
(56, 8, 13, '30000.00', '2018-07-07 15:14:59', 1, 1, '2018-07-07', '30000.00', '0.00', '0.00', 'paid', '0.00', 1902),
(57, 8, 14, '0.00', '0000-00-00 00:00:00', 1, 1, '2018-08-07', '2650.00', '477.00', '6466.00', '', '0.00', 0),
(58, 8, 14, '0.00', '0000-00-00 00:00:00', 1, 1, '2018-09-07', '2650.00', '477.00', '3604.00', '', '0.00', 0),
(59, 8, 14, '0.00', '0000-00-00 00:00:00', 1, 1, '2018-10-07', '2650.00', '0.00', '2650.00', '', '0.00', 0),
(60, 8, 14, '0.00', '0000-00-00 00:00:00', 1, 1, '2018-11-07', '2650.00', '0.00', '2650.00', '', '0.00', 0),
(61, 8, 14, '0.00', '0000-00-00 00:00:00', 1, 1, '2018-12-07', '2650.00', '0.00', '2650.00', '', '0.00', 0),
(62, 8, 14, '0.00', '0000-00-00 00:00:00', 1, 1, '2019-01-07', '2650.00', '0.00', '2650.00', '', '0.00', 0),
(63, 8, 14, '15000.00', '2018-07-07 00:00:00', 1, 1, '2018-07-07', '15000.00', '0.00', '0.00', 'paid', '0.00', 3154);
...
(6, 'Konica', '30000.00', 'Multifunction Laser', 'IMG_0274.JPG', 5, 21, 0, 78, 1, 5, 0, '6'),
(7, 'sssd', '30000.00', 'efsdf', 'default.gif', 5, 21, 0, 0, 1, 5, 0, ''),
(8, 'Canon', '13000.00', 'hjghgg', 'default.gif', 5, 21, 0, 0, 1, 5, 0, '');
...
(12, 6, 100, '2018-07-07', 1, 'Received'),
(13, 7, 5, '2018-09-13', 1, 'pending');
...
CREATE TABLE IF NOT EXISTS `sales` (
  ...
  `cust_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `cash_tendered` decimal(12,4) DEFAULT NULL,
...
(13, 8, 1, '30000.00', '0.00', '30000.00', '0.00', '2018-07-07 15:14:59', 'cash', 1, '30000.00'),
(14, 8, 1, NULL, NULL, '0.00', NULL, '2018-07-07 15:16:04', 'credit', 1, '30.00');
...
(22, 'fsfs', 12, 100, '2018-07-07 15:33:18', 1, 'Complete');
...
(20, 10, '1', 'monthly', '15900.00', '2018-03-25', '15000.00', '2018-04-25', '900.00', 'paid'),
(21, 11, '6', 'monthly', '2650.00', '2018-03-25', '15000.00', '2018-09-25', '900.00', ''),
(22, 14, '6', 'monthly', '2650.00', '2018-07-07', '15000.00', '2019-01-07', '900.00', '');
