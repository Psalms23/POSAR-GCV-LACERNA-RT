                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="input-group col-md-12">
            						<div class="input-group col-sm-12">
            						  <input type="text" class="form-control pull-right" id="date2" name="last" placeholder="Last Name" required>
            						</div><!-- /.input group -->
          					  </div><!-- /.form group -->
                    </div>
                    ...
                    <div class="col-md-4">  
                      ...
                      <div class="input-group col-md-12">
                          <input type="text" class="form-control pull-right" id="date" name="first" placeholder="Middle Name" required>
                      </div><!-- /.input group -->
                  ...
                  <div class="row">
                    <div class="col-md-4">  
                      ...
                      <div class="input-group col-md-12">
                          <input type="text" class="form-control pull-right" id="date" name="cn" placeholder="Company Name" required>
                      </div><!-- /.input group -->
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">  
                      <label for="date">Tel # or Cellphone #</label>
                      <div class="input-group col-md-12">
