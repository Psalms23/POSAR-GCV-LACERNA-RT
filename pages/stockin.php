                ...
                <th>Date Delivered</th>
                    ...
                    <tbody>
                      <?php
                          ...
                          $query=mysqli_query($con,"select * from stockin a inner join purchase_request b on a.pr_id=b.pr_id inner join product c on c.prod_id=b.prod_id where a.branch_id='$branch' order by date desc")or die(mysqli_error());
