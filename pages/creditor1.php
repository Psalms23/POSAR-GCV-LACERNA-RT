        ...
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-lg btn-primary" href="creditornew.php">Apply as Creditor</a>
            </h1>
            <ol class="breadcrumb">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:400px">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Update Requirements Details</h4>
              </div>
              <div class="modal-body">
			  <form class="form-horizontal" method="post" action="ci_update.php" enctype='multipart/form-data'>
              <div class="form-group">
					<label class="control-label col-lg-3" for="name">Remarks</label>
					<div class="col-lg-9">
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Sketch Address</label>
          <div class="col-lg-9">
          
          <input type="text" class="form-control" id="name" name="payslip" value="<?php echo $row['payslip'];?>" >  
          </div>
        </div>
                
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">2 Valid ID </label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="valid_id" value="<?php echo $row['valid_id'];?>"> 
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Brgy. Certificate </label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="cert" value=" <?php echo $row['cert'];?>"> 
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Cedula</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="cedula" value=" <?php echo $row['cedula'];?>">  
          </div>
        </div>        
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Proof of Income</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="income" value=" <?php echo $row['income1'];?>">  
          </div>
        </div>        
