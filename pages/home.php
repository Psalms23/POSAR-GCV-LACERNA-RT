                  ...
                  <div class="row">
                    <div class="col-lg-4 col-xs-10">
                        ...
                        <div class="small-box bg-maroon">
                          ...
                          <a href="http://localhost/GCV%20PosAR/pages/home2.php" class="small-box-footer">
                    ...
                    <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-gray">
                          ...
                          <a href="home4.php" class="small-box-footer">
                            Go <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-red">
                          ...
                          <a href="home3.php" class="small-box-footer">
                            Go <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div>
                       ...
                       <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-blue">
                          ...
                          <a href="home6.php" class="small-box-footer">
                            Go <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="small-box bg-navy">
                          ...
                          <a href="home5.php" class="small-box-footer">
                            Go <i class="fa fa-arrow-circle-right"></i>
                          </a>
                        </div>
                      </div><!-- ./col -->
