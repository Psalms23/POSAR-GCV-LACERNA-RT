...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from sales natural join customer natural join term where sales.sales_id='$sid'")or die(mysqli_error($con));
        ...
        $user_id=$row['user_id'];
         ...
         $queryp=mysqli_query($con,"select * from term where sales_id='$sid'")or die(mysqli_error($con));
...
?>                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th><h4>Sales Invoice#: <?php echo $row['sales_id'];?> </h4></th>
                      </tr>    
                      <tr>
...
?>                    
            ...
            <a class = "btn btn-success btn-print" href = "" onclick = "PrintDiv"><i class ="glyphicon glyphicon-print"></i>Print</a>
