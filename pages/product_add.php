...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from product where prod_name='$name' and branch_id='$branch'")or die(mysqli_error($con));
		...
		{	
			...
			mysqli_query($con,"INSERT INTO product(prod_name,prod_price,prod_desc,prod_pic,cat_id,reorder,brandid,branch_id,serial)
			VALUES('$name','$price','$desc','$pic','$category','$reorder','$brand','$branch','$serial')")or die(mysqli_error($con));
