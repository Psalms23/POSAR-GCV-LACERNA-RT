            ...
            <input type="text" class="form-control" id="name" name="desc" value="<?php echo $row['prod_desc'];?>" required>  
				...
				<div class="form-group">
                 ...
                 <div class="form-group">
					...
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="prod_brand" required>
                ...
                <div class="form-group">
					...
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="prod_model" required>
              ...
              $queryc=mysqli_query($con,"select * from category order by cat_name")or die(mysqli_error());
                ...
                <div class="form-group">
							...
							<div class="col-lg-9">
							  <select class="form-control select2" style="width: 100%;" name="prodsubcat" required>
                <1?php
            
              $queryc=mysqli_query($con,"select * from subcategory order by subcat_name")or die(mysqli_error());
                while($rowc=mysqli_fetch_array($queryc)){
                ?>
                  <option value="<1?php echo $rowc['subcatid'];?>"><1?php echo $rowc['subcat_name'];?></option>
                <1?php }?>
              </select>
							</div><!-- /.input group -->
						  </div><!-- /.form group -->
        ...
        <div class="form-group">
         ...
         <div class="form-group">
              ...
              $queryc=mysqli_query($con,"select * from subcategory order by subcat_name")or die(mysqli_error());
                while($rowc=mysqli_fetch_array($queryc)){
                ?>
                  <option value="<?php echo $rowc['subcatid'];?>"><?php echo $rowc['subcat_name'];?></option>
                <?php }?>
              </select>
              </div><!-- /.input group -->
              </div><!-- /.form group -->
         ...
         <div class="form-group">
          <label class="control-label col-lg-3" for="price">Model</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="model" placeholder="Model"  required>  
          </div>
        </div>
