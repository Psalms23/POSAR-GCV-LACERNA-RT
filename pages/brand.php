                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="brandn" placeholder="Brand" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
		  <div class="form-group">
                    <label for="date">Model</label>
                    <div class="input-group col-md-12">
                      <input type="text" class="form-control pull-right" id="date" name="brandm" placeholder="Model" required>
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                  <div class="form-group">
...
<?php
		...
		$query=mysqli_query($con,"select * from brand order by brandn")or die(mysqli_error());
