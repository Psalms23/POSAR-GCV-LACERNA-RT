            ...
            <div class="col-xs-9">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class=""><a href="#fa-icons" data-toggle="tab" aria-expanded="true">Accounts Ledger</a></li>
...
<?php
   // $cid=$_REQUEST['cid'];
    $query1=mysqli_query($con,"select * from sales natural join sales_details natural join product natural join term natural join customer where cust_id='$cid' order by date_added desc")or die(mysqli_error($con));
...
?>
        ...
        <td><?php echo date("M d, Y",strtotime($row1['date_added']));?></td>
           <td><?php echo $row1['down'];?></td>
           <td><?php echo $row1['balance'];?></td>
            <td><?php echo $row1['due'];?></td>
            <td><?php echo $row1['payable_for'];?></td> 
